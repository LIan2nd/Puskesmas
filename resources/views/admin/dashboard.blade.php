            ...
            <div class="card bg-gradient-danger card-img-holder text-white">
                <div class="card-body">
                    ...
                    <h4 class="font-weight-normal mb-3">Jumlah Pasien <i
                            class="mdi mdi-account-alert mdi-24px float-right"></i>
                    </h4>
                    <h2 class="mb-5">{{ $pasiens->count() }}</h2>
                    <h6 class="card-text">Increased
                        by 60%
                    </h6>
                </div>
            </div>
        ...
        <div class="col-md-4 stretch-card grid-margin">
            <div class="card bg-gradient-info card-img-holder text-white">
                <div class="card-body">
                    <img src="{{ asset('admin/assets/images/dashboard/circle.svg') }}" class="card-img-absolute"
                        alt="circle-image" />
                    <h4 class="font-weight-normal mb-3">Jumlah Dokter <i class="mdi mdi-account mdi-24px float-right"></i>
                    </h4>
                    <h2 class="mb-5">{{ $dokters->count() }}</h2>
